(function () {
  ...
  function setBackground(opened) {
    const previousImage = state.template.backgroundImage; const oldWidth = previousImage ? state.template.backgroundWidth : 0; const oldHeight = previousImage ? state.template.backgroundHeight : 0;
  ...
  [els.avatarRadius, els.avatarBorder, els.avatarAspect, els.nameEnabled, els.fontFamilyZh, els.fontFamilyEn, els.fontFamilyJa, els.fontSize, els.nameColor, els.nameAlign, els.nameVertical, els.letterSpacing].forEach(el => el.addEventListener("input", readTemplateInputs));
